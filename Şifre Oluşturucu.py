...
print("BİLMENİZ GEREKEN HER ŞEY PROGRAMI KURDUĞUNUZ YERDE BENİ OKU.txt DOSYASININ İÇİNDE..")
import time
time.sleep(4)
print("YÜKLENİYOR...")
print("##########")
...
!'^+%&/()=?}][{#£><.,-"$*:;|_"""
    ...
    if uzunluk == (1):
        ...
        print("Şifre Oluşturuludu: "+password)
    ...
    soru=int(input("Yeniden Oluşturmak için 1'e, Çıkmak İçin 2'ye Basınız :"))
    if soru == (1):
        continue
    elif soru == (2):
        break
